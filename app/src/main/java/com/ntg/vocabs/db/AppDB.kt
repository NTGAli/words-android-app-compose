...
@Database(entities = [Word::class, TimeSpent::class, VocabItemList::class, GermanNouns::class, GermanVerbs::class, EnglishWords::class, EnglishVerbs::class, DriveBackup::class, AdHistory::class], version = 25)
